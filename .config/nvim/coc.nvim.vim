...
" Single shortcut to bring up CocList, rather than shortcuts for individual menu
nnoremap <silent> <space>z :<C-u>CocList<cr>

" Let esc also close float window.
let g:esc_commands += [':call coc#float#close_all()']

" GoTo code navigation.
" NOTE: Same as docs example, but second char capitalized
