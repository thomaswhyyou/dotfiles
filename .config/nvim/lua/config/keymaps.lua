...
--   vim.keymap.set("n", "<leader>gl", function() Snacks.lazygit.log({ cwd = LazyVim.root.git() }) end, { desc = "Lazygit Log" })
...
-- vim.keymap.set("n", "<S-k>", "<nop>", { noremap = true })
-- vim.keymap.set("x", "<S-k>", "<nop>", { noremap = true })
